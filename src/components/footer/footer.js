    ...
    <footer className="uk-width-1-1 uk-margin-top uk-light">
      ...
      <div className="uk-grid-column-small uk-grid-row-large uk-child-width-1-2@s" data-uk-grid>
            ...
            <div>
              ...
              <a target="_blank"
                rel="noopener noreferrer" href="https://www.facebook.com/rosyroseherbalist/" className="uk-margin-small-right" uk-icon="facebook"></a>
              <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/rosyherbalist/" className="uk-margin-small-right" uk-icon="instagram"></a>
              </div>
              </div>
            </div>  
            <div>
